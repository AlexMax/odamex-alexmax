...
void AM_Drawer (void)
{
	...
	if (!(viewactive && am_overlay < 2)) {
		...
		if (sv_gametype == GM_COOP)
		{
			if (am_showmonsters)
			{
                ...
                if (viewactive && screenblocks == 11)
                    FB->DrawTextClean (CR_GREY, screen->width - screen->StringWidth(line) * CleanXfac, OV_Y - (height * 4) + 1, line);
			...
			if (am_showsecrets)
			{
                ...
                if (viewactive && screenblocks == 11)
                    FB->DrawTextClean (CR_GREY, screen->width - screen->StringWidth(line) * CleanXfac, OV_Y - (height * 3) + 1, line);
                else if (viewactive && screenblocks == 12)
                    FB->DrawTextClean (CR_GREY, screen->width - screen->StringWidth(line) * CleanXfac, screen->height - (height * 2) + 1, line);
                else
                    FB->DrawTextClean (CR_GREY, screen->width - screen->StringWidth(line) * CleanXfac, ST_Y - (height * 2) + 1, line);
			}
		}
		...
		if (am_classicmapstring)
		{
			...
			if (viewactive && screenblocks == 11)
				FB->DrawTextClean(CR_RED, screen->width - screen->StringWidth(line) * CleanXfac, OV_Y - (height * 1) + 1, line);
			else if (viewactive && screenblocks == 12)
		...
		else
		{
            ...
            if (viewactive && screenblocks == 11)
                FB->DrawTextClean (CR_GREY, screen->width - screen->StringWidth(line) * CleanXfac, OV_Y - (height * 1) + 1, line);
            else if (viewactive && screenblocks == 12)
		...
		if (am_showtime) {
            ...
            if (viewactive && screenblocks == 11)
                FB->DrawTextClean (CR_RED, screen->width - screen->StringWidth(line) * CleanXfac, OV_Y - (height * 2) + 1, line);
            else if (viewactive && screenblocks == 12)
                FB->DrawTextClean (CR_RED, screen->width - screen->StringWidth(line) * CleanXfac, screen->height - (height * 1) + 1, line);
            else
                FB->DrawTextClean (CR_RED, screen->width - screen->StringWidth(line) * CleanXfac, ST_Y - (height * 1) + 1, line);
		}
