...
//-----------------------------------------------------------------------------
//
// $Id: r_main.cpp 303 2007-09-04 01:30:38Z Nes $
//
...
void R_ExecuteSetViewSize (void)
{
	...
	if (setdetail >= 0)
	{
		...
		{
			R_RenderSegLoop = R_RenderSegLoop1;	// [ML] 2007/9/5 - Use the classic one for now in cb testing
			detailxshift = 0;
		}
...
VERSION_CONTROL (r_main_cpp, "$Id: r_main.cpp 303 2007-09-04 01:30:38Z Nes $")
