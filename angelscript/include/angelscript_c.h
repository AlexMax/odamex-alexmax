...
extern "C"
{
	...
	// Thread support
	AS_API void              asPrepareMultithread(asIThreadManager *externalMgr);
	...
	AS_API asIObjectType *	  asEngine_GetObjectTypeByName(asIScriptEngine *e, const char *name);
	...
	AS_API const char *       asEngine_GetEnumByIndex(asIScriptEngine *e, asUINT index, int *enumTypeId, const char **nameSpace, const char **configGroup, asDWORD *accessMask);
	...
	AS_API asIScriptFunction *asEngine_GetFuncdefByIndex(asIScriptEngine *e, asUINT index);
	...
	AS_API const char *       asEngine_GetTypedefByIndex(asIScriptEngine *e, asUINT index, int *typeId, const char **nameSpace, const char **configGroup, asDWORD *accessMask);
	...
	AS_API void *             asEngine_CreateUninitializedScriptObject(asIScriptEngine *e, int typeId);
	AS_API void               asEngine_AssignScriptObject(asIScriptEngine *e, void *dstObj, void *srcObj, int typeId);
	AS_API void               asEngine_ReleaseScriptObjectId(asIScriptEngine *e, void *obj, int typeId);
	AS_API void               asEngine_ReleaseScriptObject(asIScriptEngine *e, void *obj, const asIObjectType *type);
	AS_API void               asEngine_AddRefScriptObjectId(asIScriptEngine *e, void *obj, int typeId);
	AS_API void               asEngine_AddRefScriptObject(asIScriptEngine *e, void *obj, const asIObjectType *type);
	...
	AS_API void               asEngine_NotifyGarbageCollectorOfNewObject(asIScriptEngine *e, void *obj, asIObjectType *type);
	...
	AS_API void				  asEngine_SetObjectTypeUserDataCleanupCallback(asIScriptEngine *e, asCLEANOBJECTTYPEFUNC_t callback, asPWORD type);
	...
	AS_API asIObjectType     *asModule_GetObjectTypeByName(asIScriptModule *m, const char *name);
	...
	AS_API const char *       asModule_GetEnumByIndex(asIScriptModule *m, asUINT index, int *enumTypeId, const char** nameSpace);
	...
	AS_API const char *       asModule_GetTypedefByIndex(asIScriptModule *m, asUINT index, int *typeId, const char** nameSpace);
	...
	AS_API asDWORD          asObjectType_GetAccessMask(const asIObjectType *o);
	...
	AS_API const char      *asObjectType_GetNamespace(const asIObjectType *o);
	AS_API asIObjectType   *asObjectType_GetBaseType(const asIObjectType *o);
	AS_API asBOOL           asObjectType_DerivesFrom(const asIObjectType *o, const asIObjectType *objType);
	...
	AS_API int              asObjectType_GetSubTypeId(const asIObjectType *o, asUINT subTypeIndex);
	AS_API asIObjectType   *asObjectType_GetSubType(const asIObjectType *o, asUINT subTypeIndex);
	AS_API asUINT           asObjectType_GetSubTypeCount(const asIObjectType *o);
	...
	AS_API asBOOL           asObjectType_Implements(const asIObjectType *o, const asIObjectType *objType); 

	// Factories
	AS_API asUINT             asObjectType_GetFactoryCount(const asIObjectType *o);
	AS_API asIScriptFunction *asObjectType_GetFactoryByIndex(const asIObjectType *o, asUINT index);
	AS_API asIScriptFunction *asObjectType_GetFactoryByDecl(const asIObjectType *o, const char *decl);

	// Methods
	AS_API asUINT             asObjectType_GetMethodCount(const asIObjectType *o);
	AS_API asIScriptFunction *asObjectType_GetMethodByIndex(const asIObjectType *o, asUINT index, asBOOL getVirtual);
	AS_API asIScriptFunction *asObjectType_GetMethodByName(const asIObjectType *o, const char *name, asBOOL getVirtual);
	AS_API asIScriptFunction *asObjectType_GetMethodByDecl(const asIObjectType *o, const char *decl, asBOOL getVirtual);

	// Properties
	AS_API asUINT      asObjectType_GetPropertyCount(const asIObjectType *o);
	AS_API int         asObjectType_GetProperty(const asIObjectType *o, asUINT index, const char **name, int *typeId, asBOOL *isPrivate, int *offset, asBOOL *isReference, asDWORD *accessMask);
	...
	AS_API asIScriptFunction *asObjectType_GetBehaviourByIndex(const asIObjectType *o, asUINT index, asEBehaviours *outBehaviour);

	// User data
	AS_API void			   *asObjectType_SetUserData(asIObjectType *o, void *data, asPWORD type);
	AS_API void			   *asObjectType_GetUserData(asIObjectType *o, asPWORD type);
	...
	AS_API int              asFunction_GetParamTypeId(const asIScriptFunction *f, asUINT index, asDWORD *flags);
